...
const PersonalRoom = () => {
  ...
  const meetingLink:string = `${process.env.NEXT_PUBLIC_BASE_URL}/meeting/${meetingId}?personal=true`
  ...
  const startRoom = async ()=>{
    ...
    //  Create a new call if not there....
    if(!call){
  ...
  return (
    ...
    <div className='flex w-full flex-col gap-8 xl:max-w-[900px]'>
      <Table title='Topic' description={`${user?.username ?? "Temporary User"}'s Personal Meeting Room`} />
